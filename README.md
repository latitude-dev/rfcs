...
through a bit of a design process and produce a consensus among the Latitude
core team.

The "RFC" (request for comments) process is intended to provide a
consistent and controlled path for new features to enter the project.

[Active RFC List](https://github.com/latitude-dev/rfcs/pulls)


## When to follow this process

You should consider using this process if you intend to make "substantial"
changes to Latitude or its documentation. Some examples that would benefit
from an RFC are:
  ...
  - The introduction of new idiomatic usage or conventions, even if they
     do not include code changes to Latitude itself.
...
Some changes do not require an RFC:
  ...
  - Additions only likely to be _noticed by_ other implementors-of-Latitude,
  invisible to users-of-Latitude.

## What the process is

In short, to get a major feature added to Latitude, one usually first gets
the RFC merged into the RFC repo as a markdown file. At that point the RFC
is 'active' and may be implemented with the goal of eventual inclusion
into Latitude.

* Fork the RFC repo http://github.com/latitude-dev/rfcs
...
for inclusion in Latitude. Note that a team review may take a long time,
and we suggest that you ask members of the community to review it first.
* RFCs that are candidates for inclusion in Latitude will enter a "final comment
...
feature as a pull request to the Latitude repo. Becoming 'active' is not a rubber
...
Currently, the Latitude Team cannot commit to reviewing RFCs in a timely manner.
When you submit an RFC, your primary goal should be to solicit community feedback
and generate a rich discussion. The Latitude Team re-evaluates the current list of
...
We read all RFCs within a few weeks of submission. If we think the design fits Latitude well,
...
Latitude's RFC process owes its inspiration to the [React RFC process], [Yarn RFC process], [Rust RFC process], and [Ember RFC process].
